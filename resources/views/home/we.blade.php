...
<div class="banner-blog">
    <div class="content-banner-blog" style="background-image: url({{asset('images/WEBNosotros.jpg')}}); background-size:cover; background-position:cover;">        
        <div class="content-banner-blog-info">
            <h1 >Conócenos</h1>
            <h2>Conoce más acerca de nosotros y nuestro trabajo</h2>
        </div>
    </div>
</div>
<!-- Fin Banner -->

    ...
    <header>       
          <nav>
            ...
            <a href="{{route('home')}}" class="enlace">
                <img src="{{asset('../images/sinfodo.png')}}" alt="" class="logo">
            </a>
            <ul>
                <li><a href="{{route('we.index')}}"><i class="fa fa-group" aria-hidden="true"></i>Nosotros</a></li>
                <li><a href="{{route('service.index')}}"><i class="fa fa-user-md" aria-hidden="true"></i>Servicios</a></li>
                <li><a href="{{route('psy.index')}}"><i class="fa fa-vcard-o" aria-hidden="true"></i>Psicólogos</a></li>                
                <li><a href="{{route('contact.index')}}"><i class="fa fa-envelope" aria-hidden="true"></i>Contacto</a></li>
                <li><a href="{{route('blog.index')}}"><i class="fa fa-comments" aria-hidden="true"></i>Blog</a></li>
    ...
    <footer>
        <div class="grid grid-cols-1 sm:grid-cols-2 footer-page">
            <div class="grid justify-items-center footer-page-1">
                <img src="{{asset('images/sinfodo.png')}}" alt=""> 
            </div>
